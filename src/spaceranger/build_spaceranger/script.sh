...
## VIASH START
par_input_spaceranger='spaceranger.tar.gz'
par_input_bcl2fastq='bcl2fastq.zip'
par_tag='ghcr.io/data-intuitive/spaceranger:latest'
meta_functionality_name='build_spaceranger'
## VIASH END
...
cp "$par_input_spaceranger" "$tempdir/spaceranger.tar.gz"
