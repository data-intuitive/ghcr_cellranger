...
## VIASH START
par_input_cellranger_arc='cellranger_arc.tar.gz'
par_input_bcl2fastq='bcl2fastq.zip'
par_tag='ghcr.io/data-intuitive/cellranger_arc:latest'
meta_functionality_name='build_cellranger_arc'
## VIASH END
...
cp "$par_input_cellranger_arc" "$tempdir/cellranger_arc.tar.gz"
